...
class marzoListener(ParseTreeListener):
    ...
    # Enter a parse tree produced by marzoParser#arith_expr.
    def enterArith_expr(self, ctx:marzoParser.Arith_exprContext):
        pass

    # Exit a parse tree produced by marzoParser#arith_expr.
    def exitArith_expr(self, ctx:marzoParser.Arith_exprContext):
        pass
